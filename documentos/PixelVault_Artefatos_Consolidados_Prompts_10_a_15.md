...
7. As seções `A13`, `A14` e `A15` registram, respectivamente, o modelo relacional, o banco SQLite e a API Node local; decisões físicas posteriores prevalecem sobre alternativas ainda abertas nas seções anteriores.
8. A API e o SQLite não estão conectados ao aplicativo Expo. Autenticação real, processamento financeiro e integração externa com o Mercado Pago permanecem fora do incremento documentado.
9. Os gates `CONCERNS` dos Prompts 10 a 12 não bloquearam suas stories. Os Prompts 13 a 15 foram concluídos com os pareceres registrados em seus próprios artefatos.
...
| `A13` | Prompt 13 | Modelo de dados e DER | [Abrir seção](#artefato-p13) |
| `A14` | Prompt 14 | Script SQL e banco SQLite local | [Abrir seção](#artefato-p14) |
| `A15` | Prompt 15 | API Node e fronteira do Mercado Pago | [Abrir seção](#artefato-p15) |
...
## A13 - Prompt 13: Modelo de dados e DER

**Artefato de referência:** `documentos/PixelVault_Modelo_de_Dados_e_DER.md`  
**Localização estável:** seção `A13`, entre `ARTEFATO-P13-INICIO` e `ARTEFATO-P13-FIM`
...
## A14 - Prompt 14: Script SQL e banco local

**Artefato de referência:** `documentos/PixelVault_Script_SQL_e_Banco_Local.md`  
**Localização estável:** seção `A14`, entre `ARTEFATO-P14-INICIO` e `ARTEFATO-P14-FIM`
...
## A15 - Prompt 15: API Node e fronteira do Mercado Pago

**Artefato de referência:** `documentos/PixelVault_API_Node_e_Fronteira_Mercado_Pago.md`  
**Localização estável:** seção `A15`, entre `ARTEFATO-P15-INICIO` e `ARTEFATO-P15-FIM`
